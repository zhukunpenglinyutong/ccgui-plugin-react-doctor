/**
 * 内联 SVG 图标（lucide 风格：24 viewBox、stroke=currentColor、stroke-width 2）。
 * 不引 lucide-react 依赖，保持 bundle 精简；CSS 统一控制尺寸。
 */
import type { ReactNode } from "react";

function svg(paths: ReactNode): (props: { className?: string }) => ReactNode {
...
export const AlertCircleIcon = svg(
  <>
